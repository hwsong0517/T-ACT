...
4. 부적합 시, 아래 우선순위에 따라 수정을 제안하여 반드시 'PASS'가 되도록 하십시오:
   - 목표: 제안된 수치를 적용했을 때 누적 공차 범위가 목표 범위(Target Gap)의 중앙에 가깝게 위치하도록 하고, 여유분(Margin)을 최소 0.01mm 이상 확보하십시오.
   - 1순위: '가공품'의 공차를 정밀화하여 전체 범위를 좁힙니다. (최소 ±0.03mm)
...
{
  "analysisMarkdown": "상세 분석 내용을 포함한 마크다운 텍스트. 현재 왜 Fail인지, 어떤 전략(공차 정밀화 또는 치수 변경)을 사용했는지 설명하십시오.",
  "suggestions": [
    {
      "partName": "부품명",
